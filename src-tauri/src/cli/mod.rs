...
fn print_help() {
    ...
    println!("  3. dshbox build [boxfile.dsh] [--name <image>]");
    ...
    println!("  4. dshbox run <image> [--name <container>]");
    println!("     create a container from the image and start it (a template name");
    println!("     still works and builds implicitly)");
    println!();
    ...
    println!("  dshbox build [path]           build an image from a boxfile (default ./boxfile)");
    println!("  dshbox run <image|template>   create a container from an image (or template) and start it");
    println!();
    println!("Images:");
    println!("  dshbox image ls               list the local image registry");
    println!("  dshbox image show <name>      print one image's resource list");
    println!("  dshbox image rm <name>        remove an image (refuses if in use)");
